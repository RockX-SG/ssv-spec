...
func ThirteenOperators() *MsgProcessingSpecTest {
	...
	return &MsgProcessingSpecTest{
		...
		Messages: []*types.ParsedKGMessage{
			...
			dkgtu.SignDKGMsg(ks.DKGOperators[11].SK, suite.R1(11)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[12].SK, suite.R1(12)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[13].SK, suite.R1(13)).(*types.ParsedKGMessage),
			...
			dkgtu.SignDKGMsg(ks.DKGOperators[11].SK, suite.R2(11)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[12].SK, suite.R2(12)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[13].SK, suite.R2(13)).(*types.ParsedKGMessage),
			...
			dkgtu.SignDKGMsg(ks.DKGOperators[11].SK, suite.R3(11, 1)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[12].SK, suite.R3(12, 1)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[13].SK, suite.R3(13, 1)).(*types.ParsedKGMessage),
			...
			dkgtu.SignDKGMsg(ks.DKGOperators[11].SK, suite.R4(11)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[12].SK, suite.R4(12)).(*types.ParsedKGMessage),
			dkgtu.SignDKGMsg(ks.DKGOperators[13].SK, suite.R4(13)).(*types.ParsedKGMessage),
		},
	}
}
